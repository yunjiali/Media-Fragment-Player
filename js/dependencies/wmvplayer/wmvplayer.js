...
jeroenwijering.Player.prototype = {
	...
	/*
	 * Yunjia: Add some more functions
	 */
	getEvent:function(typ){
		if(this.model && this.model.video)
		{
				switch(typ.toUpperCase()) {
				case 'DURATION':
					return Math.round(this.model.video.NaturalDuration.Seconds*10)/10;
					break;
				case 'POSITION':
					return Math.round(this.model.video.Position.Seconds*10)/10;
					break;
			}
		}
	}
